...
class Clinica:
    ...
    def adicionar_profissional(self, p):
        self.__profissionais.append(p)

    def remover_profissional(self, p):
        self.__profissionais.remove(p)

    def definir_profissionais(self, profissionais: list):
        self.__profissionais = list(profissionais)